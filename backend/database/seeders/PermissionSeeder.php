...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['code' => 'USER.RESET_PASSWORD', 'name' => 'Reset Password', 'module' => 'users'],

            // Employee Management
            ['code' => 'EMPLOYEE.VIEW', 'name' => 'View Employees', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.CREATE', 'name' => 'Create Employee', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.EDIT', 'name' => 'Edit Employee', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.DELETE', 'name' => 'Delete Employee', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.VIEW_ATTENDANCE', 'name' => 'View Attendance', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.VIEW_PROJECTS', 'name' => 'View Projects', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.VIEW_APPROVALS', 'name' => 'View Approvals', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.VIEW_HISTORY', 'name' => 'View History', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.ACTIVATE', 'name' => 'Activate Employee', 'module' => 'employees'],
            ['code' => 'EMPLOYEE.DEACTIVATE', 'name' => 'Deactivate Employee', 'module' => 'employees'],

            // Module Access
            ['code' => 'MODULE.DASHBOARD', 'name' => 'Access Dashboard', 'module' => 'dashboard'],
            ['code' => 'MODULE.PROJECTS', 'name' => 'Access Projects', 'module' => 'projects'],
            ['code' => 'MODULE.FIELD_MONITORING', 'name' => 'Access Field Monitoring', 'module' => 'projects'],
            ['code' => 'MODULE.ATTENDANCE', 'name' => 'Access Attendance', 'module' => 'attendance'],
            ['code' => 'MODULE.APPROVAL', 'name' => 'Access Approvals', 'module' => 'approvals'],
            ['code' => 'MODULE.CASH_IN', 'name' => 'Access Cash In', 'module' => 'finance'],
            ['code' => 'MODULE.CASH_OUT', 'name' => 'Access Cash Out', 'module' => 'finance'],
            ['code' => 'MODULE.PETTY_CASH', 'name' => 'Access Petty Cash', 'module' => 'finance'],
            ['code' => 'MODULE.LARGE_CASH', 'name' => 'Access Large Cash', 'module' => 'finance'],
            ['code' => 'MODULE.ACCOUNTING', 'name' => 'Access Accounting', 'module' => 'accounting'],
            ['code' => 'MODULE.REPORTS', 'name' => 'Access Reports', 'module' => 'reports'],
            ['code' => 'MODULE.FINANCE', 'name' => 'Access Finance', 'module' => 'finance'],
            ['code' => 'MODULE.USER_MANAGEMENT', 'name' => 'Access User Management', 'module' => 'users'],
            ['code' => 'MODULE.EMPLOYEE_MANAGEMENT', 'name' => 'Access Employee Management', 'module' => 'employees'],
            ['code' => 'MODULE.SETTINGS', 'name' => 'Access Settings', 'module' => 'settings'],
            ['code' => 'MODULE.NOTIFICATION', 'name' => 'Access Notifications', 'module' => 'settings'],
            ['code' => 'MODULE.AUDIT_LOG', 'name' => 'Access Audit Log', 'module' => 'audit'],
            ['code' => 'MODULE.GPS_MONITORING', 'name' => 'Access GPS Monitoring', 'module' => 'attendance'],
            ['code' => 'MODULE.DOCUMENT_UPLOAD', 'name' => 'Access Document Upload', 'module' => 'projects'],
            ['code' => 'MODULE.PROJECT_PROGRESS', 'name' => 'Access Project Progress', 'module' => 'projects'],
