    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">End your work day</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{workHours.toFixed(1)} hours</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Check Out Status</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    ...
                    <Badge variant={location ? "success" : "secondary"}>
                      {location ? "Verified" : "Optional"}
                    </Badge>
                  </div>
                  ...
                  <Button 
                    ...
                    disabled={!photoTaken || isCheckingOut}
                  >
                    {isCheckingOut ? (
                      <>
                  ...
                  {!photoTaken && (
                    <div className="flex items-center gap-2 text-sm text-amber-600 p-2 bg-amber-50 rounded">
                      ...
                      <span>Please take a photo before checking out</span>
                    </div>
                  )}
                </div>
              </CardContent>
